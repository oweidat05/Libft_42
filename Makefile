...
# كل الدوال معاً (42 دالة)
SRC = ft_strlen.c ft_strlcat.c ft_strlcpy.c ft_isalpha.c ft_isdigit.c \
      ft_isalnum.c ft_isascii.c ft_isprint.c ft_memset.c ft_bzero.c \
      ft_memcpy.c ft_memmove.c ft_toupper.c ft_tolower.c ft_strchr.c \
